...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      className={cn(
        'bg-card flex h-14 flex-row items-center justify-center rounded-lg p-[4px] px-[5px]',
  ...
  return (
    <TextClassContext.Provider
      ...
      <TabsPrimitive.Trigger
        className={cn(
          'flex h-[calc(100%-1px)] flex-row items-center justify-center gap-1.5 rounded-md border border-transparent px-2 py-3.5 shadow-none shadow-black/5',
          Platform.select({
